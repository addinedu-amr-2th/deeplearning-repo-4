...
def gen_frames():
    ...
    while True:
        try:
            ...
            #     cv2.rectangle(image, (x,y), (w,h), (100, 100, 100), 3)
            for (x, y, w, h) in faces:
                ...
                # landmarks_display = landmarks[27:48]
                landmarks_display = [*landmarks[0:17], *landmarks[27:31], *landmarks[36:48]]
                ...
                for point in landmarks_display:
                    pos = (point[0, 0], point[0, 1])
                    cv2.circle(image, pos, 2, color=(0, 255, 255), thickness=-1)

                cv2.putText(image, ss, (10, 25),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
